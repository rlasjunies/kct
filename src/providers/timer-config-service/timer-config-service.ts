    ...
    public getAll(): model.TimerConfig[] {
        ...
        if (!this._config) {
            ...
            var config: model.IConfig = {
                ...
                timersConfig: [
                    { guid: '569dc9e5-8874-46bc-9e92-1c8cfbdaf0a3', weekdays: 62, title: 'Paul - game', durationMilliSecond: 5400000, durationHumanized: '01:30', picture: 'build/assets/images/rlas.png', enable: true },
                    ...
                    { guid: '17913ab4-b7b2-4aba-af9f-01e6019844b3', weekdays: 254, title: 'Louis - game', durationMilliSecond: 5400000, durationHumanized: '01:30', picture: 'build/assets/images/rlas.png', enable: true },
